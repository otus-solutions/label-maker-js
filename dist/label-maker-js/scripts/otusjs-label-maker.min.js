...
(function() {
    ...
    angular
      ...
      .component('biggerLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="column" layout-align="start center" class="bigger-label" xmlns="http://www.w3.org/1999/html"><p>{{$ctrl.baseInfo.participant_name}}</p><div class="label-text" layout-align="space-between center" layout="row" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>{{$ctrl.baseInfo.recruitment_number}}</span><br></div><div class="label-text" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>DN: {{$ctrl.baseInfo.birthday}} SEXO: {{$ctrl.baseInfo.gender}}</span><br></div><svg ng-show="$ctrl.type == \'barcode\'" id="participantbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="participantqr" class="qrcode"></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="column" layout-align="start center" class="bigger-label"><p>{{$ctrl.biomaterial.label}}</p><div class="label-text"><span>{{$ctrl.biomaterial.code}}</span><br></div><div layout-align="start start"><div class="label-text" ng-show="$ctrl.identified" layout="row" layout-align="space-between center" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>PART.:{{$ctrl.baseInfo.participant_name}}</span><br><span>SEXO: {{$ctrl.baseInfo.gender}}</span><br></div><div class="label-text" ng-show="!$ctrl.identified" layout="row" layout-align="space-between center" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>PART.:_______</span><br><span>SEXO:__</span><br></div><div class="label-text" ng-show="$ctrl.identified" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>RN:{{$ctrl.baseInfo.recruitment_number}}</span><br></div><div class="label-text" ng-show="!$ctrl.identified" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>RN:___________</span><br></div><div class="label-text" ng-show="$ctrl.identified" layout-align="space-between center" layout="row" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>DN:{{$ctrl.baseInfo.birthday}}</span><br><span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">KIT:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div><div class="label-text" ng-show="!$ctrl.identified" layout="row" layout-align="space-between center" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>DN:_______</span><br><span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">KIT:____</span><br></div></div><div class="label-text" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'></div><svg ng-show="$ctrl.type == \'barcode\'" id="biomaterialbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="biomaterialqr" class="qrcode"></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout="column" layout-align="start center" class="bigger-label"><p>Laboratório</p><div class="label-text" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br></div><div class="label-text" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br></div><div class="label-text" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>KIT:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div><svg ng-show="$ctrl.type == \'barcode\'" id="unattachedbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="unattachedqr" class="qrcode"></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
