...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><bigger-label ng-repeat="biomaterial in $ctrl.biomaterialList" biomaterial="biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></bigger-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterialList: '<'
...
(function() {
    ...
    angular
      ...
      .component('participantLabel', {
          transclude: true,
          template:'<div><small-label component-label="\'participant\'" base="$ctrl.baseInfo"></small-label></div>',
          controller: Controller,
          bindings: {
            base: '<'
          }
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><participant-label base="$ctrl.baseInfo"><unattached-label base="$ctrl.baseInfo"><biomaterial-label base="$ctrl.baseInfo" biomaterial-list="$ctrl.bioMaterialList"></biomaterial-label></unattached-label></participant-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
