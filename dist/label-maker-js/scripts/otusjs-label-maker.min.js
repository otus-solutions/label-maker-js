...
(function() {
    ...
    angular
      ...
      .component('smallLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="row" class="small-label"><div class="small-useble-label"><div layout="row"><svg ng-show="$ctrl.type == \'barcode\'" id="participantbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="participantqr" class="qrcode"></div><div class="label-vertical-text"><p>{{$ctrl.baseInfo.participant_name}}</p><p>NR:{{$ctrl.baseInfo.recruitment_number}}</p><p>KIT:{{$ctrl.baseInfo.recruitment_number}}</p><p>SEXO:{{$ctrl.baseInfo.gender}}</p><p>DN:{{$ctrl.baseInfo.birthday}}</p></div></div></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="row" class="small-label"><div class="small-useble-label"><div class="label-text"><p>{{$ctrl.biomaterial.label}}</p></div><div layout="row"><svg ng-show="$ctrl.type == \'barcode\'" id="biomaterialbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="biomaterialqr" class="qrcode"></div><div class="label-vertical-text"><p>{{$ctrl.biomaterial.code}}</p><p>KIT:{{$ctrl.biomaterial.code}}</p><p>P:{{$ctrl.baseInfo.participant_name}}</p><p>NR:{{$ctrl.baseInfo.recruitment_number}}</p></div></div></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout="row" class="small-label"><div class="small-useble-label"><svg ng-show="$ctrl.type == \'barcode\'" id="unattachedbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="unattachedqr" class="qrcode"></div></div><div class="small-unuseble-label"></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
