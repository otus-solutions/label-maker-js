...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><small-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></small-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
...
(function() {
    ...
    angular
      ...
      .component('unattachedLabel', {
          transclude: true,
          template:'<div><small-label component-label="\'unattached\'" base="$ctrl.baseInfo"></small-label></div>',
          controller: Controller,
          bindings: {
            base: '<',
            labInfo: '='
