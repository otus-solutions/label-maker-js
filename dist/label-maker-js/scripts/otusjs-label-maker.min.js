...
(function() {
    ...
    angular
      ...
      .component('biggerLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="column" layout-align="start center" class="bigger-label"><p>{{$ctrl.baseInfo.participant_name}}</p><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>{{$ctrl.baseInfo.recruitment_number}}</span><br></div><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>DN: {{$ctrl.baseInfo.birthday}}</span><br></div><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="column" layout-align="start center" class="bigger-label"><p>{{$ctrl.biomaterial.label}}</p><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>{{$ctrl.baseInfo.participant_name}}</span><br></div><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>NR: {{$ctrl.baseInfo.recruitment_number}}</span><br></div><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="column" layout-align="start center" class="bigger-label"><div class="bigger-label-text"><p>Laboratório</p><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br></div><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'unattached\'" class="bigger-label"><div class="bigger-label-text"><p>Laboratório</p><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br></div><svg id="unattached" class="barcode"></svg></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><default-label biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><h1>bio</h1></default-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
...
(function() {
    ...
    angular
      ...
      .component('participantLabel', {
          transclude: true,
          template:'<div><h1>participant</h1></div>',
          controller: Controller,
          bindings: {
            base: '<'
          }
...
(function() {
    ...
    angular
      ...
      .component('unattachedLabel', {
          transclude: true,
          template:'<div><h1>unattached</h1></div>',
          controller: Controller,
          bindings: {
            base: '<',
            labInfo: '='
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><biomaterial-label base="$ctrl.baseInfo" biomaterial="biomaterial" ng-repeat="biomaterial in $ctrl.bioMaterialList track by $index"></biomaterial-label><participant-label base="$ctrl.baseInfo" ng-if="$ctrl.laboratoryInfo.laboratoryIdentification == null"></participant-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
