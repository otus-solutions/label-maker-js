...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><h1>here</h1><participant-label base="$ctrl.baseInfo"><biomaterial-label base="$ctrl.baseInfo" biomaterial-list="$ctrl.bioMaterialList"></biomaterial-label></participant-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
