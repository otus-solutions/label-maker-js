...
(function() {
    ...
    angular
      ...
      .component('smallLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="row" class="small-label"><div class="small-useble-label"><svg id="participant" class="barcode"></svg></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="row" class="small-label"><div class="small-useble-label"><svg id="biomaterial" class="barcode"></svg></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout="row" class="small-label"><div class="small-useble-label"><svg id="unattached" class="barcode"></svg></div><div class="small-unuseble-label"></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
    ...
    angular
      ...
      .component('biggerLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="column" layout-align="start center" class="bigger-label"><p>{{$ctrl.baseInfo.participant_name}}</p><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>{{$ctrl.baseInfo.recruitment_number}}</span><br></div><div ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>DN: {{$ctrl.baseInfo.birthday}}</span><br></div><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="column" layout-align="start center" class="bigger-label"><p>{{$ctrl.biomaterial.label}}</p><div ng-show="$ctrl.baseInfo.printStructure.identified.value" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>{{$ctrl.baseInfo.participant_name}}</span><br></div><div ng-show="$ctrl.baseInfo.printStructure.identified.value" ng-style=\'{"overflow": "hidden","white-space": "nowrap","text-overflow": "ellipsis"}\'><span>NR: {{$ctrl.baseInfo.recruitment_number}}</span><br></div><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'unattached\'" class="bigger-label"><div class="bigger-label-text"><p>Laboratório</p><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br></div><svg id="unattached" class="barcode"></svg></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><default-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><small-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><bigger-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></bigger-label></small-label></default-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
...
(function() {
    ...
    angular
      ...
      .component('participantLabel', {
          transclude: true,
          template:'<div><default-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" component-label="\'participant\'" base="$ctrl.baseInfo"><small-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" component-label="\'participant\'" base="$ctrl.baseInfo"><bigger-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" component-label="\'participant\'" base="$ctrl.baseInfo"></bigger-label></small-label></default-label></div>',
          controller: Controller,
          bindings: {
            base: '<'
          }
...
(function() {
    ...
    angular
      ...
      .component('unattachedLabel', {
          transclude: true,
          template:'<div><default-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" component-label="\'unattached\'" base="$ctrl.baseInfo"><small-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" component-label="\'unattached\'" base="$ctrl.baseInfo"><bigger-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" component-label="\'unattached\'" base="$ctrl.baseInfo"></bigger-label></small-label></default-label></div>',
          controller: Controller,
          bindings: {
            base: '<',
            labInfo: '='
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><participant-label base="$ctrl.baseInfo" ng-if="$ctrl.laboratoryInfo.laboratoryIdentification == null || $ctrl.baseInfo.printStructure.identified.value"></participant-label><unattached-label base="$ctrl.laboratoryInfo" ng-if="$ctrl.laboratoryInfo.laboratoryIdentification != null"></unattached-label><biomaterial-label base="$ctrl.baseInfo" biomaterial="biomaterial" ng-repeat="biomaterial in $ctrl.bioMaterialList track by $index"></biomaterial-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
