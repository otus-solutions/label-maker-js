...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><default-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><small-label biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><bigger-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></bigger-label></small-label></default-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
