...
(function() {
    ...
    angular
      ...
      .component('defaultLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\' && $ctrl.type == \'barcode\'" class=default-label><div class=default-label-text><h3>{{$ctrl.baseInfo.participant_name}}</h3><div layout=row layout-align="space-between center"><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>S.:{{$ctrl.baseInfo.gender}}</span></div></div><div layout-align="space-between center" layout=row flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div layout-align="space-between center" layout=row flex><span>DN:{{$ctrl.baseInfo.birthday}}</span> <span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">K.: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div><svg id=participantbarcode class=barcode></svg></div><div ng-show="$ctrl.componentLabel == \'participant\' && $ctrl.type == \'qrcode\'" layout=row layout-align="space-between center" class=default-label><div><div class=default-label-text><h3>{{$ctrl.baseInfo.participant_name}}</h3><div layout=row layout-align="space-between center"><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>S.:{{$ctrl.baseInfo.gender}}</span></div></div><div layout-align="space-between center" layout=row flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div layout-align="space-between center" layout=row flex><span>DN:{{$ctrl.baseInfo.birthday}}</span> <span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">Kit: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div></div><div><div id=participantqr class=qrcode></div></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\' && $ctrl.type == \'barcode\'" class=default-label><p>{{$ctrl.biomaterial.label}}</p><div ng-show=$ctrl.identified layout=row layout-align="space-between center"><span>{{$ctrl.baseInfo.participant_name}}</span><br><span>S.:{{$ctrl.baseInfo.gender}}</span></div><div ng-show=!$ctrl.identified layout=row layout-align="space-between center"><span>P.:_______</span><br><span>S.:__</span></div><div ng-show=$ctrl.identified layout-align="space-between center" layout=row flex><span>N.:{{$ctrl.baseInfo.recruitment_number}}</span></div><div ng-show=!$ctrl.identified layout-align="space-between center" layout=row flex><span>N.:_______</span></div><div ng-show=$ctrl.identified layout-align="space-between center" layout=row flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><div ng-show=!$ctrl.identified layout-align="space-between center" layout=row flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><svg id=biomaterialbarcode class=barcode></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\' && $ctrl.type == \'qrcode\'" layout=row layout-align="space-between center" class=default-label><div><p>{{$ctrl.biomaterial.label}}</p><div ng-show=$ctrl.identified layout=row layout-align="space-between center"><span>{{$ctrl.baseInfo.participant_name}}</span><br><span>S.:{{$ctrl.baseInfo.gender}}</span></div><div ng-show=!$ctrl.identified layout=row layout-align="space-between center"><span>P.:_______</span><br><span>S.:__</span></div><div ng-show=$ctrl.identified layout-align="space-between center" layout=row flex><span>N.:{{$ctrl.baseInfo.recruitment_number}}</span></div><div ng-show=!$ctrl.identified layout-align="space-between center" layout=row flex><span>N.:_______</span></div><div ng-show=$ctrl.identified layout-align="space-between center" layout=row flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><div ng-show=!$ctrl.identified layout-align="space-between center" layout=row flex><span>DN:______</span></div><div flex><span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">Kit: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div></div><div><div id=biomaterialqr class=qrcode></div></div></div><div ng-show="$ctrl.componentLabel == \'unattached\' && $ctrl.type == \'barcode\'" class=default-label><div><p>Laboratório</p><span>C.:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>K.:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div><svg ng-show="$ctrl.type == \'barcode\'" id=unattachedbarcode class=barcode></svg></div><div ng-show="$ctrl.componentLabel == \'unattached\' && $ctrl.type == \'qrcode\'" layout=row layout-align="space-between center" class=default-label><div><p>Laboratório</p><div><span>C.:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>K.:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div></div><div><div ng-show="$ctrl.type == \'qrcode\'" id=unattachedqr class=qrcode></div></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
    ...
    angular
      ...
      .component('smallLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout=row class=small-label><div class=small-useble-label><div layout=row layout-align="space-between center" ng-show="$ctrl.type ==\'barcode\' && $ctrl.baseInfo.laboratoryIdentification == null"><p>{{$ctrl.baseInfo.participant_name.slice(0, 12)}}<span ng-show="$ctrl.baseInfo.participant_name.length > 12">...</span></p></div><div layout=row layout-align="space-between center" ng-show="$ctrl.type ==\'barcode\' && $ctrl.baseInfo.laboratoryIdentification == null"><p>{{$ctrl.baseInfo.birthday}}</p><p>S:{{$ctrl.baseInfo.gender}}</p></div><p ng-show="$ctrl.type == \'qrcode\'" style="position: relative; left: 5px; top:4px" class=above-text>{{$ctrl.baseInfo.participant_name.slice(0, 12)}}<span ng-show="$ctrl.baseInfo.participant_name.length > 12">...</span></p><div layout=row><svg ng-show="$ctrl.type == \'barcode\'" id=participantbarcode class=barcode></svg><div ng-show="$ctrl.type == \'qrcode\'" id=participantqr class=qrcode></div><div ng-show="$ctrl.type == \'qrcode\'" class=label-text><p>N:{{$ctrl.baseInfo.recruitment_number}}</p><p>S:{{$ctrl.baseInfo.gender}}</p><p>{{$ctrl.baseInfo.birthday}}</p></div></div></div><div class=small-unuseble-label></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout=row class=small-label><div class=small-useble-label><div layout=row layout-align="space-between center"><p ng-show="$ctrl.type ==\'barcode\'">{{$ctrl.biomaterial.label}}</p><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.baseInfo.laboratoryIdentification != null">K:{{$ctrl.baseInfo.laboratoryIdentification}}</p></div><div layout=row layout-align="space-between center"><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">{{$ctrl.baseInfo.participant_name.slice(0, 8)}}<span ng-show="$ctrl.baseInfo.participant_name.length > 8">...</span></p><p ng-show="$ctrl.type ==\'barcode\' && !$ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">P:_______</p><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">D:{{$ctrl.baseInfo.birthday}}</p><p ng-show="$ctrl.type ==\'barcode\' && !$ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">D:__/__/____</p></div><p ng-show="$ctrl.type == \'qrcode\'" style="position: relative; left: 5px; top: 4px" class=above-text>{{$ctrl.biomaterial.label}}</p><div layout=row><svg ng-show="$ctrl.type == \'barcode\'" id=biomaterialbarcode class=barcode></svg><div ng-show="$ctrl.type == \'qrcode\'" id=biomaterialqr class=qrcode></div><div ng-show="$ctrl.type == \'qrcode\'" class=label-text><p>{{$ctrl.biomaterial.code}}</p><p ng-show="$ctrl.baseInfo.laboratoryIdentification != null">K:{{$ctrl.baseInfo.laboratoryIdentification}}</p><p ng-show="$ctrl.baseInfo.laboratoryIdentification == null && $ctrl.identified">{{$ctrl.baseInfo.participant_name.slice(0, 7)}}<span ng-show="$ctrl.baseInfo.participant_name.length > 8">...</span></p><p ng-show="$ctrl.baseInfo.laboratoryIdentification == null && !$ctrl.identified">{{$ctrl.baseInfo.participant_name.slice(0, 7)}}P:_______</p><p ng-show=$ctrl.identified>N:{{$ctrl.baseInfo.recruitment_number}}</p><p ng-show=!$ctrl.identified>N:________</p></div></div></div><div class=small-unuseble-label></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout=row class=small-label><div class=small-useble-label><p ng-show="$ctrl.type == \'qrcode\'" class=above-text>Laboratório</p><div ng-show="$ctrl.type ==\'barcode\'"><p>Laboratório</p></div><div layout=row layout-align="space-between center" ng-show="$ctrl.type ==\'barcode\'"><p>C:{{$ctrl.baseInfo.laboratoryFieldCenter}}</p><p>K:{{$ctrl.baseInfo.laboratoryIdentification}}</p></div><div layout=row><svg ng-show="$ctrl.type == \'barcode\'" id=unattachedbarcode class=barcode></svg><div ng-show="$ctrl.type == \'qrcode\'" id=unattachedqr class=qrcode></div><div ng-show="$ctrl.type == \'qrcode\'" class=label-text><p>C:{{$ctrl.baseInfo.laboratoryFieldCenter}}</p><p>CQ:{{$ctrl.baseInfo.cq_group}}</p><p>K:{{$ctrl.baseInfo.laboratoryIdentification}}</p><p>_________</p></div></div></div><div class=small-unuseble-label></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id=print-page layout-align="center center" ng-if=$ctrl.loadComponents><ul layout-align="center center" ng-class="\'label-grid\'"><li ng-if="$ctrl.laboratoryInfo.laboratoryIdentification == null && $ctrl.baseInfo.printStructure.identified.value"><participant-label base=$ctrl.baseInfo ng-if="$ctrl.laboratoryInfo.laboratoryIdentification == null && $ctrl.baseInfo.printStructure.identified.value"></participant-label></li><li ng-if="$ctrl.laboratoryInfo.laboratoryIdentification != null"><unattached-label base=$ctrl.laboratoryInfo ng-if="$ctrl.laboratoryInfo.laboratoryIdentification != null"></unattached-label></li><li class=green ng-repeat="biomaterial in $ctrl.newbiomaterialList track by $index"><biomaterial-label base=$ctrl.baseInfo biomaterial=biomaterial></biomaterial-label></li></ul></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
