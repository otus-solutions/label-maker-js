...
(function() {
    ...
    angular
      ...
      .component('defaultLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\' && $ctrl.type == \'barcode\'" class="default-label"><div class="default-label-text"><h3>{{$ctrl.baseInfo.participant_name}}</h3><div layout="row" layout-align="space-between center"><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>Sexo:{{$ctrl.baseInfo.gender}}</span></div></div><div layout-align="space-between center" layout="row" flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div layout-align="space-between center" layout="row" flex><span>DN:{{$ctrl.baseInfo.birthday}}</span> <span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">Kit: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div><svg id="participantbarcode" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'participant\' && $ctrl.type == \'qrcode\'" layout="row" layout-align="space-between center" class="default-label"><div><div class="default-label-text"><h3>{{$ctrl.baseInfo.participant_name}}</h3><div layout="row" layout-align="space-between center"><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>Sexo:{{$ctrl.baseInfo.gender}}</span></div></div><div layout-align="space-between center" layout="row" flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div layout-align="space-between center" layout="row" flex><span>DN:{{$ctrl.baseInfo.birthday}}</span> <span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">Kit: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div></div><div><div id="participantqr" class="qrcode"></div></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\' && $ctrl.type == \'barcode\'" class="default-label"><p>{{$ctrl.biomaterial.label}}</p><div ng-show="$ctrl.identified" layout="row" layout-align="space-between center"><span>{{$ctrl.baseInfo.participant_name}}</span><br><span>Sexo:{{$ctrl.baseInfo.gender}}</span></div><div ng-show="!$ctrl.identified" layout="row" layout-align="space-between center"><span>Part:_______</span><br><span>Sexo:__</span></div><div ng-show="$ctrl.identified" layout-align="space-between center" layout="row" flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div ng-show="!$ctrl.identified" layout-align="space-between center" layout="row" flex><span>NR:_______</span></div><div ng-show="$ctrl.identified" layout-align="space-between center" layout="row" flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><div ng-show="!$ctrl.identified" layout-align="space-between center" layout="row" flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><svg id="biomaterialbarcode" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\' && $ctrl.type == \'qrcode\'" layout="row" layout-align="space-between center" class="default-label"><div><p>{{$ctrl.biomaterial.label}}</p><div ng-show="$ctrl.identified" layout="row" layout-align="space-between center"><span>{{$ctrl.baseInfo.participant_name}}</span><br><span>Sexo:{{$ctrl.baseInfo.gender}}</span></div><div ng-show="!$ctrl.identified" layout="row" layout-align="space-between center"><span>Part:_______</span><br><span>Sexo:__</span></div><div ng-show="$ctrl.identified" layout-align="space-between center" layout="row" flex><span>NR:{{$ctrl.baseInfo.recruitment_number}}</span></div><div ng-show="!$ctrl.identified" layout-align="space-between center" layout="row" flex><span>NR:_______</span></div><div ng-show="$ctrl.identified" layout-align="space-between center" layout="row" flex><span>DN:{{$ctrl.baseInfo.birthday}}</span></div><div ng-show="!$ctrl.identified" layout-align="space-between center" layout="row" flex><span>DN:______</span></div><div flex><span ng-show="$ctrl.baseInfo.laboratoryIdentification != null">Kit: {{$ctrl.baseInfo.laboratoryIdentification}}</span></div></div><div><div id="biomaterialqr" class="qrcode"></div></div></div><div ng-show="$ctrl.componentLabel == \'unattached\' && $ctrl.type == \'barcode\'" class="default-label"><div><p>Laboratório</p><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>KIT:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div><svg ng-show="$ctrl.type == \'barcode\'" id="unattachedbarcode" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'unattached\' && $ctrl.type == \'qrcode\'" layout="row" layout-align="space-between center" class="default-label"><div><p>Laboratório</p><div><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br><span>KIT:{{$ctrl.baseInfo.laboratoryIdentification}}</span><br></div></div><div><div ng-show="$ctrl.type == \'qrcode\'" id="unattachedqr" class="qrcode"></div></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
    ...
    angular
      ...
      .component('smallLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="row" class="small-label"><div class="small-useble-label"><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.baseInfo.laboratoryIdentification == null">{{$ctrl.baseInfo.participant_name}}</p><div layout="row"><svg ng-show="$ctrl.type == \'barcode\'" id="participantbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="participantqr" class="qrcode"></div><div ng-show="$ctrl.type == \'qrcode\'" class="label-text"><p>{{$ctrl.baseInfo.participant_name}}</p><p>NR:{{$ctrl.baseInfo.recruitment_number}}</p><p>GEN:{{$ctrl.baseInfo.gender}}</p><p>{{$ctrl.baseInfo.birthday}}</p></div></div></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="row" class="small-label"><div class="small-useble-label"><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">{{$ctrl.baseInfo.participant_name}}</p><p ng-show="$ctrl.type ==\'barcode\' && !$ctrl.identified && $ctrl.baseInfo.laboratoryIdentification == null">Part.:_______</p><p ng-show="$ctrl.type ==\'barcode\' && $ctrl.baseInfo.laboratoryIdentification != null">Kit:{{$ctrl.baseInfo.laboratoryIdentification}}</p><div layout="row"><svg ng-show="$ctrl.type == \'barcode\'" id="biomaterialbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="biomaterialqr" class="qrcode"></div><div ng-show="$ctrl.type == \'qrcode\'" class="label-text"><p>{{$ctrl.biomaterial.label}}</p><p>{{$ctrl.biomaterial.code}}</p><p ng-show="$ctrl.baseInfo.laboratoryIdentification != null">K:{{$ctrl.baseInfo.laboratoryIdentification}}</p><p ng-show="$ctrl.baseInfo.laboratoryIdentification == null && $ctrl.identified">P:{{$ctrl.baseInfo.participant_name}}</p><p ng-show="$ctrl.identified">NR:{{$ctrl.baseInfo.recruitment_number}}</p><p ng-show="!$ctrl.identified">NR:________</p></div></div></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout="row" class="small-label"><div class="small-useble-label"><div layout="row"><p ng-show="$ctrl.type ==\'barcode\'">{{$ctrl.baseInfo.laboratoryFieldCenter}}</p><svg ng-show="$ctrl.type == \'barcode\'" id="unattachedbarcode" class="barcode"></svg><div ng-show="$ctrl.type == \'qrcode\'" id="unattachedqr" class="qrcode"></div><div ng-show="$ctrl.type == \'qrcode\'" class="label-text"><p>Laboratório</p><p>CEN:{{$ctrl.baseInfo.laboratoryFieldCenter}}</p><p>CQ:{{$ctrl.baseInfo.cq_group}}</p><p>K:{{$ctrl.baseInfo.laboratoryIdentification}}</p><p>_________</p></div></div></div><div class="small-unuseble-label"></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
