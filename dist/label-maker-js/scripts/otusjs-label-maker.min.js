...
(function() {
    ...
    angular
      ...
      .component('smallLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" layout="row" class="small-label"><div class="small-useble-label"><svg id="participant" class="barcode"></svg></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="row" class="small-label"><div class="small-useble-label"><svg id="biomaterial" class="barcode"></svg></div><div class="small-unuseble-label"></div></div><div ng-show="$ctrl.componentLabel == \'unattached\'" layout="row" class="small-label"><div class="small-useble-label"><p>lab.</p><svg id="unattached" class="barcode"></svg></div><div class="small-unuseble-label"></div></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><participant-label base="$ctrl.baseInfo"></participant-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
