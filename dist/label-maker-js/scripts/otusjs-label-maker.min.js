...
(function() {
    ...
    angular
      ...
      .component('biggerLabel', {
          transclude: true,
          template:'<div ng-show="$ctrl.componentLabel == \'participant\'" class="bigger-label"><svg id="participant" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'biomaterial\'" layout="column" layout-align="center center" class="bigger-label"><p>{{$ctrl.biomaterial.label}}</p><svg id="biomaterial" class="barcode"></svg></div><div ng-show="$ctrl.componentLabel == \'unattached\'" class="bigger-label"><div class="bigger-label-text"><p>Laboratório</p><span>Centro:{{$ctrl.baseInfo.laboratoryFieldCenter}}</span><br><span>CQ:{{$ctrl.baseInfo.cq_group}}</span><br></div><svg id="unattached" class="barcode"></svg></div>',
          controller: Controller,
          bindings: {
            componentLabel: "<",
            base: '<',
