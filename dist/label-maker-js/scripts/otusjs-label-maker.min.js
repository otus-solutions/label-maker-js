...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><unattached-label base="$ctrl.laboratoryInfo"><participant-label base="$ctrl.baseInfo"><h1>here</h1><biomaterial-label base="$ctrl.baseInfo" biomaterial-list="$ctrl.bioMaterialList"></biomaterial-label></participant-label></unattached-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
