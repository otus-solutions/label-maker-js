...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><default-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><small-label ng-show="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><bigger-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"><h1>bio</h1></bigger-label></small-label></default-label></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
...
(function() {
    ...
    angular
      ...
      .component('participantLabel', {
          transclude: true,
          template:'<div><default-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" component-label="\'participant\'" base="$ctrl.baseInfo"><small-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" component-label="\'participant\'" base="$ctrl.baseInfo"><bigger-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'bigger\'" component-label="\'participant\'" base="$ctrl.baseInfo"></bigger-label></small-label></default-label></div>',
          controller: Controller,
          bindings: {
            base: '<'
          }
...
(function() {
    ...
    angular
      ...
      .component('unattachedLabel', {
          transclude: true,
          template:'<div><default-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'default\'" component-label="\'unattached\'" base="$ctrl.baseInfo"><small-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" component-label="\'unattached\'" base="$ctrl.baseInfo"><bigger-label ng-if="$ctrl.baseInfo.printStructure.labelSize.value == \'small\'" component-label="\'unattached\'" base="$ctrl.baseInfo"></bigger-label></small-label></default-label></div>',
          controller: Controller,
          bindings: {
            base: '<',
            labInfo: '='
...
(function() {
  ...
  function directive($window, $compile, LabelService) {
    var ddo = {
      ...
      scope: {},
      transclude: true,
      template:'<div id="print-page" layout-align="start center" ng-if="$ctrl.loadComponents"><participant-label base="$ctrl.baseInfo" ng-if="$ctrl.laboratoryInfo.laboratoryIdentification == null"></participant-label><unattached-label base="$ctrl.laboratoryInfo" ng-if="$ctrl.laboratoryInfo.laboratoryIdentification != null"></unattached-label><biomaterial-label base="$ctrl.baseInfo" biomaterial="biomaterial" ng-repeat="biomaterial in $ctrl.bioMaterialList track by $index"></biomaterial-label></div>',
      controller: Controller,
      controllerAs: '$ctrl',
    };
