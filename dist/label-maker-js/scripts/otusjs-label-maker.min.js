...
(function() {
  ...
  angular
    ...
    .component('biomaterialLabel', {
      transclude: true,
      template:'<div><div ng-show="$ctrl.labelSize == \'default\'"><default-label biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></default-label></div><div ng-show="$ctrl.labelSize == \'small\'"><small-label biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></small-label></div><div ng-show="$ctrl.labelSize == \'bigger\'"><bigger-label biomaterial="$ctrl.biomaterial" base="$ctrl.baseInfo" component-label="\'biomaterial\'"></bigger-label></div></div>',
      controller: Controller,
      bindings: {
        base: '<',
        biomaterial: '<'
